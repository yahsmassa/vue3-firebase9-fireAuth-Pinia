<template>
  <div class="container h-screen flex justify-center items-center">
    <div class="p-8 max-w-6xl">
      ...
      <h2 class="font-bold text-2xl text-center dark:text-gray-50 mb-8">Simple TODO Appli</h2>
